...
| File | Size | Use |
|---|---|---|
| `logo/cia-token-1000.png` | 1000×1000 | The $CIA image on pump.fun: **Crying Cat, sobbing with a thumbs up** (wallets crop it round; it is circle-safe) |
...
| `source/` | | The coin logo at 2160 px (and the earlier Director version), the roster scene, the Director portrait, the seamless pixel floor tile, and the building concept image, as generated |
