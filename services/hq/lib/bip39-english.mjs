/**
 * THE BIP-39 ENGLISH WORD LIST: 2,048 PUBLIC WORDS, NOTHING SECRET.
 *
 * Copied from https://github.com/bitcoin/bips/blob/master/bip-0039/english.txt, read on
 * 2026-09-25; that file (one word a line, a final newline) has the SHA-256
 * 2f5eed53a4727b4bf8880d8f3f199efc90e58503646d9ff8eff3a2ed3b24dbda, the hash BIP-39's
 * reference implementations pin, and test-hq-wallet.mjs re-derives it from this array.
 * wallet.mjs reads it to check a recovery phrase's words and checksum, and to write a new
 * phrase in keygen.mjs. Solana wallets (Phantom, solana-keygen) use the same list.
 */
