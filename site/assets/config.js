/* THE AGENCY'S ONE CONFIG: every value the site cannot know yet.
   ...
   buyUrl           where to buy that same mint: its pump.fun or GMGN page (the URL must contain
                    the address)
   hqApi            Agency HQ's API origin, once HQ is online: https://api.catintelligenceagency.com
                    and nothing else (assets/hq-client.js refuses any other). Empty, every HQ page
                    says HQ is coming online and shows no number. */
window.CIA_CONFIG = {
  xUrl: "",
